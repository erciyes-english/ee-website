              ...
              <div className={registerFormStyles.registerFormWrapper}>
                ...
                <Form>
                  ...
                  {values.course === "Children's Program" ? (
                    <div className={registerFormStyles.inputTwoCol}>
                      <FieldWrapper
                        fieldName="childfname"
                        label={t({
                          id: "registerForm.childfname.label",
                          message: "Child's First Name*",
                        })}
                        placeholder={t({
                          id: "registerForm.childfname.placeholder",
                          message: "Billy",
                        })}
                      />
                      <FieldWrapper
                        fieldName="childlname"
                        label={t({
                          id: "registerForm.childlname.label",
                          message: "Child's Last Name*",
                        })}
                        placeholder={t({
                          id: "registerForm.childlname.placeholder",
                          message: "Smith",
                        })}
                      />
                    </div>
